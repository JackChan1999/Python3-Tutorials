...
`# -*- coding: utf-8 -*-L = [('Bob', 75), ('Adam', 92), ('Bart', 66), ('Lisa', 88)]``L2 = sorted(L, key=by_name)print(L2)`** Run

再按成绩从高到低排序：

`# -*- coding: utf-8 -*-L = [('Bob', 75), ('Adam', 92), ('Bart', 66), ('Lisa', 88)]``L2 = sorted(L, key=by_score)print(L2)`** Run
