...
`# -*- coding:utf-8 -*-import refrom datetime import datetime, timezone, timedelta``# 测试:t1 = to_timestamp('2015-6-1 08:10:30', 'UTC+7:00')assert t1 == 1433121030.0, t1t2 = to_timestamp('2015-5-31 16:10:30', 'UTC-09:00')assert t2 == 1433121030.0, t2print('ok')`** Run
